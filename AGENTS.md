...
- Update docs when behavior, settings, metrics, package options, setup steps, or supported OpenWrt versions change, including when a documented feature's behavior changes or a new user-facing feature is added.
