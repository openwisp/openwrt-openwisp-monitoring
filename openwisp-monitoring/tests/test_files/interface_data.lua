  ...
  interface = {
    {
      ...
      pending = false,
      proto = "dhcp",
      route = {{target = "0.0.0.0", mask = 0, nexthop = "192.168.1.1", source = "192.168.1.41/32"}},
      up = true,
      updated = {"addresses"},
      uptime = 773875
    }, {
      ...
      pending = false,
      proto = "dhcp",
      route = {{mask = 0, nexthop = "10.0.2.1", source = "10.0.2.4/32", target = "0.0.0.0"}},
      up = true,
      updated = {"addresses", "routes", "data"},
      uptime = 132
    }, {
      ...
      pending = false,
      proto = "wireguard",
      route = {{target = "172.16.0.1", mask = 32, nexthop = "0.0.0.0", source = "0.0.0.0/0"}},
      up = true,
...
test_data.br_lan_interface = {
  addresses = {
    {address = "192.168.1.41", family = "ipv4", gateway = "192.168.1.1", mask = 24, proto = "dhcp"}
  },
