...
function TestInterface.test_get_interface_info()
  ...
  interface_info = interface_functions.get_interface_info('br-lan2', interface_data.br_lan2_interface)
  luaunit.assertEquals(interface_info, {dns_servers = {"8.8.8.8", "8.8.4.4"}, stp = true})
  -- Test STP is set false
  interface_info = interface_functions.get_interface_info('br-lan3', interface_data.br_lan3_interface)
  luaunit.assertEquals(interface_info, {dns_servers = {"8.8.8.8", "8.8.4.4"}, stp = false})
...
function TestNetJSON.test_interfaces()
  ...
  luaunit.assertEquals(netjson["interfaces"][3]["addresses"][1]["address"], "192.168.1.41")
